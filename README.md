...
* **setBackgroundColor($r, $g, $b ,$bgAlpha = 0)**, sets the background color to force it (this will disable many effects and is not recommended), bgAlpha is the transparency of the background color, 0 is fully opaque, 127 is fully transparent
...
// Added by Mickey Mickeywaugh@qq.com
* **setImageType($type)**, sets the image type to "jpeg", "png" or "gif";
...
```php
use Mickeywaugh\Captcha\CaptchaBuilder;
use Mickeywaugh\Captcha\PhraseBuilder;
